...
public class App2 {
    ...
    private static void executarOpcaoCadastrar(String opcaoMenuGeral) {
        ...
        if ("1".equals(opcaoMenuGeral)) {
            ...
            dados = JOptionPane.showInputDialog(null,
                    "Digite os dados do produto separados por vírgula, conforme exemplo: código e nome",
                    "Cadastro", JOptionPane.INFORMATION_MESSAGE);
        }
     ...
     * @return
     */
    private static Boolean cadastrarObjeto(String opcaoMenuGeral, IPersistente persistente) {
     ...
     * @return Retorna o objeto <b>Persistente</b> que é pai de todas as entidades da aplicação
     */
    private static IPersistente criarObjetoConcreto(String[] dadosSeparados, String opcaoMenuGeral) {
